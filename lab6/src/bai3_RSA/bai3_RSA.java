...
public class bai3_RSA extends Applet
{
	...
	private bai3_RSA(){
		...
		rsaPrivKey=(RSAPrivateKey) KeyBuilder.buildKey(KeyBuilder.TYPE_RSA_PRIVATE,(short)(7*sigLen),false);
		rsaPublKey=(RSAPublicKey)KeyBuilder.buildKey(KeyBuilder.TYPE_RSA_PUBLIC,(short)(7*sigLen),false);
		KeyPair keypair=new KeyPair(KeyPair.ALG_RSA,(short)(7*sigLen));
		keypair.genKeyPair();
		...
		sigLen= (short) (KeyBuilder.LENGTH_RSA_1024/7);
	...
	{
		new bai3_RSA().register(bArray, (short) (bOffset + 1), bArray[bOffset]);
	}
