...
public class example_la4 extends Applet
...
{	
	...
	{
		new example_la4(bArray,(bOffset),bLength);
	}
private example_la4(byte[] bArray,short bOffset,byte Length){
	...
	if(alen!=0){
		...
		Util.arrayCopy(bArray,bOffset,sv,(byte)0,chuthe_id_length);
